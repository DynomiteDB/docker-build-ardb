...
case "$1" in
    purge|remove|upgrade|failed-upgrade|abort-install|abort-upgrade|disappear)
		...
		#
		# Group must be deleted AFTER user
		#
		...
		update-rc.d -f dynomitedb-lmdb remove
		update-rc.d -f dynomitedb-leveldb remove
		update-rc.d -f dynomitedb-rocksdb remove
		update-rc.d -f dynomitedb-wiredtiger remove
    ;;
